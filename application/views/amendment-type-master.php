...
{
	$FileName="Amendment-Type-Master-".date("F-j-Y").".xlsx";
...
<head>
    ...
    <title>Circulation | Amendment Type</title>
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <?php echo form_open_multipart('Masters/CreateAmendmentType','name="amendment_type_form" id="amendment_type_form" onsubmit="return CIRCULATION.utils.formValidation(this);" '); ?>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>Type Code</label>
                            <input autocomplete="off" type="text" class="form-control" value="<?php echo $amt_code; ?>" readonly/>
                            </div>

                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>Type Name</label>
                            <input autocomplete="off" required type="text" class="form-control isAlpha" id="type_name" name="type_name" />
                            </div>            

                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">     
                                <label>&nbsp;</label>                           
                                <button class="btn btn-block btn-primary" type="submit" id="submit_form"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>
                            </div>    
                        <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                            <label>&nbsp;</label>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-results"  id="amendment-type-table" width="100%" >
                            <thead>
                                <tr>
                                    <td style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;"> #</td>
                                    <td style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;">Type Name</td>
                            ...
                            <tbody>
                                ...
                                if(count($amt_list)) {
                                $i=1;
                                foreach($amt_list as $type) { ?>
                                <tr data-save="false" data-edtcode="<?php //echo $ed->edition_code; ?>">
                                    
                                    <td ><?php echo $i++; ?></td>
                                    <td class="type-name"><?php echo $type->type_name; ?></td>
                                    <td class="type-status"><?php if($type->cancel_flag == Status::Active){echo "Active"; } else{echo "Disable";}?> </td>
                                    <td class="remove_on_excel" align="center">
                                        <button data-id="<?php echo $type->type_code; ?>" data-product="<?php //echo $i->issue_product_code; ?>" class="btn btn-primary type-edit-btn"><i class="fa fa-pencil" aria-hidden="true"></i></button>
