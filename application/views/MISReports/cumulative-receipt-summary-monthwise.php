...
<head>
    ...
    <title>Circulation | Cumulative Receipt Summary Monthwise</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Cumulative Receipt Summary Monthwise</h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>MIS Reports</li>
                    <li class="active">Cumulative Receipt Summary Monthwise</li>
                </ol>
            </section>
...
<table width="100%" class="table table-results" border="1">
  <thead>
    ...
    <tr>
        ...
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-right-color:#cfcdcd;">MARCH</td>
        ...
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-right-color:#cfcdcd;">APRIL</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-right-color:#cfcdcd;">MAY</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-right-color:#cfcdcd;">AVERAGE</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
        <td style="background-color: #cfcdcd; font-weight: bold; color:#000000;border:1px solid #ecf0f5;border-left-color:#cfcdcd;border-right-color:#cfcdcd;">&nbsp;</td>
