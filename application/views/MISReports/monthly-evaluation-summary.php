...
{
    $FileName="Monthly-Evaluation-Summary-".date("F-j-Y").".xlsx";
...
<head>
    ...
    <title>Circulation | Monthly Evaluation Summary</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Monthly Evaluation Summary</h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>MIS Reports</li>
                    <li class="active">Monthly Evaluation Summary</li>
                </ol>
            </section>
                ...
                <div class="box">
                    <div class="box-body">
                        <table width="100%" class="table table-results" border="1">
                          <thead>
                            <tr>
                              <td colspan="25" style="background-color: #e7f2f4; font-weight: bold; color:#000000;"> Monthly Evaluation Summary |
                                Billing Period: 01-JUL-2019 TO 31-JUL-2019 | 
                                Report Type: Unitwise |
                                Units: THIRUVANANTHAPURAM, KOLLAM </td>
                            </tr>
                            <tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="right">0</td>
                              <td align="right">1</td>
                              <td align="right">3,39,067</td>
                              <td align="right">2,65,654</td>
                              ...
                              <td align="right">1,64,500</td>
                              <td align="right">2,00,730</td>
