...
{
	$FileName="Copy-Group-Master-".date("F-j-Y").".xlsx";
...
<head>
    ...
    <title>Circulation |Copy Group Master</title>
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <form method="post" action="<?php echo base_url('AdminTools/CreateCopyGroups'); ?>" name="unit_master" id="unit_master" onsubmit="return CIRCULATION.utils.formValidation(this);">
                            <span class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <label>Group Code</label>
                                <input autocomplete="off" required type="text" class="form-control" id="copy_group_code" value="<?php echo $cpygrp_code; ?>" name="copy_group_code" readonly />
                            </span>
                            <span class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <label>Group Name</label>
                                <input autocomplete="off" required type="text" class="form-control isAlpha" id="copy_group_name" name="copy_group_name" />
                            </span>
                            
                            <span class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <label>Copy Code</label>
                                <select name="copy_code" id="copy_code" class="form-control" required >
                                    <?php foreach($grpcpy_code as $grup){?>
                                        <option value="<?php echo $grup->copy_code;?>"><?php echo $grup->copy_name;?></option>
                                    <?php } ?>
                                </select>
                            </span>
                    ...
                    <div class="box-body table-responsive">
                        <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                            <table class="table table-results" id="group-table" style="width:100%">
                                <thead>
                                    <tr>
                                        <th style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;">Group Name</th>
                                        <th style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;">Group Copy Code</th>
                                ...
                                <tbody>
                                    <?php
                                    if(count($copy_groups)) {
                                        foreach($copy_groups as $grp) {?>
                                                    
                                    <tr data-save="false" data-grpid="<?php //echo $pdt_grp->group_code; ?>">
                                       
                                        <td class="group-name"><?php echo $grp->group_name; ?></td>
                                        <td class="copy-name"><?php echo $grp->copy_name; ?> </td>
                                        <td class="group-status"><?php if( $grp->cancel_flag == ResidenceStatus::Active){echo "Active";}else{echo "Disabled";}?> </td>
                                        <td class="remove_on_excel" align="center">
                                            <button data-id="<?php echo $grp->group_code; ?>"class="btn btn-primary grp-edit-btn btn-xs"><i class="fa fa-edit fa-1x"></i></button>
