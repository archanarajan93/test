...
{
    $FileName="Other-Receipts-PDC-".date("F-j-Y").".xlsx";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Transactions</li>
                    <li>Accounts</li>
                    <li class="active">Other Receipts PDCS</li>                    
                </ol>
            </section>
            ...
            <section class="content">
                    ...
                    <div class="box-body table-responsive">
                        <form method="post" action="" name="sch-srch-form" id="sch-srch-form" onsubmit="return CIRCULATION.utils.formValidation(this);">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                                <a href="<?php echo base_url('Transactions/CreateOtherReceiptsPDC'); ?>">
               ...
               <div class="box">                    
                    <div class="box-body table-responsive">
                        <table class="table table-results <?php echo $count ? "" : "no-data-tbl"; ?>" id="other-rcpt-pdc" width="100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                if($count) {
                                    ...
                                    foreach($sch_rcpt_records as $rec) {
                                        $scheme_rcpt_code = Enum::encrypt_decrypt(Encode::Encrypt,$rec->pdc_no,$en_key);
                                        $rec_amount += $rec->pdc_amount;
                                        $subscriber = explode('#&', $rec->subscriber);
                                        ?>
                                <tr>
                                    <td style="border:1px solid #ecf0f5;"><?php echo $rec->pdc_no; ?></td>
                                    <td style="border:1px solid #ecf0f5;"><?php echo date("d-m-Y", strtotime($rec->pdc_date)); ?></td>
                                    ...
                                    <td align="right" style="border:1px solid #ecf0f5;"><?php echo moneyFormat($rec->pdc_amount); ?></td>
                                    <!--<td style="border:1px solid #ecf0f5;"><?php echo $rec->pdc_no; ?></td>-->
                                    ...
                                    <td style="border:1px solid #ecf0f5;" class="remove_on_excel">
                                        <button onclick="window.location='<?php echo base_url('Transactions/ViewOtherReceiptsPDC/'.$scheme_rcpt_code);?>'" class="btn btn-success view-rcpt-scheme" title="View"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View</button>
                                        <button onclick="window.location='<?php echo base_url('Transactions/UpdateOtherReceiptsPDC/'.$scheme_rcpt_code);?>'" class="btn btn-primary edit-rcpt-scheme" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit</button>
                                        <button data-id="<?php echo $scheme_rcpt_code; ?>" class="btn btn-danger del-rcpt-pdc"><i class="fa fa-trash-o" aria-hidden="true" title="Delete"></i>&nbsp;Delete</button>
                                    </td>
                                </tr>
                                <?php }
                                } 
