...
<head>
    ...
    <title>Circulation | Other Receipts PDC Edit</title>
                        ...
                        <form method="post" action="<?php echo base_url('Transactions/UpsertOtherReceiptsPDC'); ?>" name="scheme-rcpt-form" id="scheme-rcpt-form">
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <div class="input-group search-module" data-selected="true">
                                    ...
                                    <input type="hidden" name="copy_type_rec_sel" class="copy_type_clr" id="copy_type_rec_sel" value="<?php echo rawurlencode(json_encode(array("Name"=>$sch_rcpt_details->copytype_name,"Code"=>$sch_rcpt_details->copytype_code,"Copy"=>$sch_rcpt_details->copy_name,"Group"=>$sch_rcpt_details->group_name)));?>"/>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <div class="input-group search-module" data-selected="true">
                                    ...
                                    <input type="hidden" name="subscriber_rec_sel" class="subscriber_clr" id="subscriber_rec_sel" value="<?php echo rawurlencode(json_encode(array("Serial No"=>$sch_rcpt_details->pdc_scheme_code,"Scheme"=>$sch_rcpt_details->copytype_name,"Subscriber Code"=>$subscriber[0],"Name"=>$subscriber[1],"Address"=>$subscriber[2],"Amount"=>"","Pending Amount"=>"")));?>" />
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control"  tabindex="3" id="against_chqbounce" name="against_chqbounce">
                                    <option <?php if($sch_rcpt_details->pdc_against_dis=='0') echo 'selected';?> value="0">No</option>
                                    <option <?php if($sch_rcpt_details->pdc_against_dis=='1') echo 'selected';?> value="1">Yes</option>
                                </select>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 chq_rcpt hide">
                                <label>Receipt No.</label>
                                <div class="input-group search-module" data-selected="true">
                                    <input autocomplete="off" value="<?php echo $sch_rcpt_details->pdc_against_dis_code;?>" type="text"  tabindex="4" class="form-control" id="receipt_no" name="receipt_no" data-request='{"id":"9","search":""}' 
                                    ...
                                    <input type="hidden" name="receipt_no_rec_sel" class="receipt_no_clr" id="receipt_no_rec_sel" value="<?php echo rawurlencode(json_encode(array("Receipt No"=>$sch_rcpt_details->pdc_against_dis_code,"Amount"=>"")));?>" />
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 chq_det">
                                ...
                                <input value="<?php echo $sch_rcpt_details->pdc_chq_no; ?>" autocomplete="off"  tabindex="6" type="number" isRequired="true" class="form-control isNumberKey" id="sch_chq_no" name="sch_chq_no" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 chq_det">
                                <label>Cheque Date</label>
                                <input value="<?php echo date("d-m-Y", strtotime($sch_rcpt_details->pdc_chq_date)); ?>" autocomplete="off"  tabindex="7" type="text" isRequired="true" class="form-control" id="sch_chq_dte" name="sch_chq_dte"  data-inputmask="'alias': 'dd-mm-yyyy'" data-mask />
                            </div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>Amount</label>
                                <input <?php if($this->user->user_id!=1){?> readonly <?php }?> value="<?php echo $sch_rcpt_details->pdc_amount; ?>"  tabindex="12" style="text-align:right" autocomplete="off" type="text" class="form-control isNumberKey" id="sch_amt" name="sch_amt" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 prom_det hide">
                                ...
                                <div class="input-group search-module" data-selected="true">
                                    <input autocomplete="off" tabindex="15" value="<?php echo $sch_rcpt_details->pdc_temp_rec; ?>" type="text" class="form-control" id="tmp_rcpt" name="tmp_rcpt" data-request='{"id":"9","search":""}' data-select="{}" data-multiselect="false" placeholder="" />
                                    <input type="hidden" name="promoter_rec_sel" class="promoter_clr" id="promoter_rec_sel" value="<?php echo rawurlencode(json_encode(array("Receipt No"=>$sch_rcpt_details->pdc_temp_rec)));?>">
                                    <div class="input-group-addon btn" id="tmp_rcpt_search" data-search="tmp_rcpt"><i class="fa fa-search"></i></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12" >
                                <label>Remarks</label>
                                <textarea  class="form-control"  tabindex="16" id="remarks" name="remarks" rows="1" style="height:34px"><?php echo $sch_rcpt_details->pdc_remarks; ?></textarea>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>

                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>&nbsp;</label>
                                <button class="btn btn-block btn-primary"  tabindex="17" type="submit" id="scheme-rcpt-save"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Update</button>
                            </div>
