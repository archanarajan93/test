                    ...
                    <div class="box-body table-responsive">
                        <form method="post" action="<?php echo base_url('Transactions/UpsertOtherReceipts'); ?>" name="scheme-rcpt-form" id="scheme-rcpt-form">
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <input autocomplete="off" readonly type="text" class="form-control input-bold-text" name="sch_rcpt_view_no" id="sch_rcpt_view_no" value="<?php echo @$sch_rcpt_code; ?>" />
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <input value="<?php echo $sch_rcpt_dte;?>" autocomplete="off" readonly type="text" class="form-control" id="sch_rec_dte" name="sch_rec_dte" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control" id="pay_type"  tabindex="6" name="pay_type">
                                    <?php
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 chq_det hide">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 card_det hide">
                                <label>Card No.</label>
                                <input value="" autocomplete="off" tabindex="9" isRequired="true" type="number" class="form-control isNumberKey" id="sch_card_no" name="sch_card_no" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 card_det hide">
                                <label>Card Name</label>
                                <input value="" autocomplete="off"  tabindex="10"type="text"  isRequired="true" class="form-control isAlpha" id="sch_card_name" name="sch_card_name" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 card_det hide">
                                <label>Card Expiry</label>
                                <input value="" autocomplete="off" tabindex="11" type="text"  class="form-control" id="sch_card_exp" name="sch_card_exp" />
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 bank_det hide">
                                <label>Bank</label>
                                <div class="input-group search-module" data-selected="true">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>&nbsp;</label>
                                <button class="btn btn-block btn-primary"  tabindex="18" type="button" id="scheme-rcpt-save"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Save</button>
                            </div>
