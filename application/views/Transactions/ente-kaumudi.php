...
{
    $FileName="Ente-Kaumudi-".date("F-j-Y").".xlsx";
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <form method="post" action="<?php echo base_url('Transactions/EnteKaumudi?g_fe=results'); ?>" name="trans-form" id="trans-form" onsubmit="return CIRCULATION.utils.formValidation(this);">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>&nbsp;</label>
                                <a href="<?php echo base_url('Transactions/CreateEnteKaumudi'); ?>">
                        ...
                        <table class="table table-results <?php echo $count ? "" : "no-data-tbl"; ?>" border="1" id="records-table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <td align="right" style="background: #cfcdcd;color: #000000; font-weight:bold;">Copies</td>
                                    <td style="background: #cfcdcd;color: #000000; font-weight:bold;">Created Date</td>                                  
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                if($count) {
                                    ...
                                    foreach($records as $r) {
                                        $sum += $r->ek_deal_amt; ?>
                                <tr data-id="<?php echo base64_encode($r->ek_slno); ?>">                                    
                                    <td><?php echo $slno++; ?></td>
                                    <td><?php echo $r->ek_slno; ?></td>
                                    <td><?php echo $r->client_name.", ".$r->client_address.", ".$r->client_phone; ?></td>
                                    <td align="right"><?php echo moneyFormat($r->ek_deal_amt); ?></td>
                                    <td align="right"><?php echo $r->ek_copies; ?></td>
