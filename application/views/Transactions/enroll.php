...
{
    $FileName="Enroll-".date("F-j-Y").".xlsx";
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <form method="post" action="<?php echo base_url('Transactions/Enroll?g_fe=results'); ?>" name="trans-form" id="trans-form" onsubmit="return CIRCULATION.utils.formValidation(this);">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control" name="pause_status">
                                    ...
                                    <option <?php echo @$_POST['pause_status'] == '1' ? "selected" : ""; ?> value="1">Avoid Pause</option>
                                    <option <?php echo @$_POST['pause_status'] == '2' ? "selected" : ""; ?> value="2">Pause Alone</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>&nbsp;</label>
                                <a href="<?php echo base_url('Transactions/EnrollCreate'); ?>">
                        ...
                        <table class="table table-results <?php echo $count ? "" : "no-data-tbl"; ?>" border="1" id="records-table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <td style="background: #0a98b4;color: #FFF;">From Date</td>
                                    <td style="background: #0a98b4;color: #FFF;">To Date</td>
                                    ...
                                    <td style="background: #0a98b4;color: #FFF;">Serviced By</td>
                                    <td style="background: #0a98b4;color: #FFF;">Department</td>
                                    <td style="background: #0a98b4;color: #FFF;">Intial Status</td>
                                    <td style="background: #0a98b4;color: #FFF;">Final Status</td>
                                    <td style="background: #0a98b4;color: #FFF;">Intial Response</td>
                                    <td style="background: #0a98b4;color: #FFF;">Final Response</td>
                                    <td style="background: #0a98b4;color: #FFF;">Token No</td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                <tr data-id="<?php echo base64_encode($r->sales_code); ?>">                                    
                                    ...
                                    <td><?php echo ($r->sales_end_flag && $r->sales_end_date) ? date('d-m-Y',strtotime($r->sales_end_date)) : ""; ?></td>
                                    ...
                                    <td><?php echo $r->sales_service_name; ?></td>
                                    <td><?php echo $r->sales_service_dept; ?></td>
                                    <td><?php //echo $r->product_name; ?></td>
                                    <td><?php //echo $r->product_name; ?></td>
                                    <td><?php //echo $r->product_name; ?></td>
                                    <td><?php //echo $r->product_name; ?></td>
                                    <td><?php echo $r->sales_crm_token; ?></td>
                                </tr>
                                <?php }
                                } 
                                else {
