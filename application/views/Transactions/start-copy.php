...
{
    $FileName="Start-Copy-".date("F-j-Y").".xlsx";
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <form method="post" action="<?php echo base_url('Transactions/StartCopy?g_fe=results'); ?>" name="trans-form" id="trans-form" onsubmit="return CIRCULATION.utils.formValidation(this);">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control" name="sales_status">
                                    ...
                                    <option <?php echo @$_POST['sales_status'] == '1' ? "selected" : ""; ?> value="1">Pending</option>
                                    <option <?php echo @$_POST['sales_status'] == '2' ? "selected" : ""; ?> value="2">Started</option>
                                </select>
                            </div>
