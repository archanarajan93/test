...
{
	$FileName="Amendment-Reason-Master-".date("F-j-Y").".xlsx";
...
<head>
    ...
    <title>Circulation | Amendment Reason</title>
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <?php echo form_open_multipart('Masters/CreateAmendmentReason','name="amendment_form" id="amendment_form" onsubmit="return CIRCULATION.utils.formValidation(this);" '); ?>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>Reason Code</label>
                            <input autocomplete="off" type="text" class="form-control" value="<?php echo $amnd_code; ?>" readonly/>
                            </div>

                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                                <label>Reason Name</label>
                            <input autocomplete="off" required type="text" class="form-control isAlpha" id="reason_name" name="reason_name" />
                            </div>            

                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">     
                                <label>&nbsp;</label>                           
                                <button class="btn btn-block btn-primary" type="button" id="submit_form"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>
                            </div>    
                        <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                            <label>&nbsp;</label>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-results"  id="amendment-table" width="100%" >
                            <thead>
                                <tr>
                                    <td style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;"> #</td>
                                    <td style="background:#cfcdcd; color:#000000; font-weight:bold; border:1px solid #ecf0f5;">Reason Name</td>
                            ...
                            <tbody>
                                ...
                                if(count($amnd_list)) {
                                $i=1;
                                foreach($amnd_list as $amnd) { ?>
                                <tr data-save="false" data-edtcode="<?php //echo $ed->edition_code; ?>">
                                    
                                    <td ><?php echo $i++; ?></td>
                                    <td class="resn-name"><?php echo $amnd->reason_name; ?></td>
                                    <td class="resn-status"><?php if($amnd->cancel_flag == Status::Active){echo "Active"; } else{echo "Disable";}?> </td>
                                                                           
                                    <td class="remove_on_excel" align="center">
                                        <button data-id="<?php echo $amnd->reason_id; ?>" data-product="<?php //echo $i->issue_product_code; ?>" class="btn btn-primary reason-edit-btn"><i class="fa fa-pencil" aria-hidden="true"></i></button>
